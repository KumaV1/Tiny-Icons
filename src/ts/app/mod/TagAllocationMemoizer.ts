...
export class TagAllocationMemoizer {
  ...
  static getEntityContextTags(category: string, id: string): TagDataObject | undefined {
    ...
    private static initModData() {
        // Add data from mods, that have been collected until now
    }

    /** */
    private static initModifierTagMap() {
        this.modifierTagMap = new Map<string, ModifierTagMapEntryAttributes>([
