export const zhCN = {
  ...
  SETTINGS_SETTING_MANUAL_TAGGING_HINT: 'Enable iconizations that have been explicitly added to certain entities (for example, manually providing a specific set of icons to a specific equipment item). | NOTE: Does not adhere to settings below. They are basically akin to "static", "global" icons that do not differentiate between "primary" and "secondary". (this may be improved upon in a future update)',
