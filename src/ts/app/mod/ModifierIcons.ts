...
export class ModifierIconPaths {
   ...
   */
  public readonly iconCategories = {
    itemIcons: {
    ...
    generalIcons: {
      ancient_relics: this.iconPath('main', 'gamemode_ancient_relic', 'png'),
    ...
    skillMedia: {
      ...
      ti_attack_interval: this.iconPath('mod', 'attack_interval'),
      ti_combat_dn: this.iconPath('mod', 'combat_dn'),
      ti_combat_up: this.iconPath('mod', 'combat_up'),
      ti_dr_dn: this.iconPath('mod', 'dr_dn'),
      ti_dr_up: this.iconPath('mod', 'dr_up'),
      ti_magic_dn: this.iconPath('mod', 'magic_dn'),
      ti_magic_up: this.iconPath('mod', 'magic_up'),
      ti_ranged_dn: this.iconPath('mod', 'ranged_dn'),
      ti_ranged_up: this.iconPath('mod', 'ranged_up'),
      ti_strength_dn: this.iconPath('mod', 'strength_dn'),
      ti_strength_up: this.iconPath('mod', 'strength_up'),
   ...
   */
  public readonly srcForTag: { [key: string]: string } = Object.values(
    this.iconCategories
  ).reduce((acc, category) => {
    return { ...acc, ...category };
  }, {});
